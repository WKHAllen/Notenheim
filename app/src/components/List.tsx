      ...
      <div className="d-flex ListItem">
        <div className="p-2">
          <label className="checkbox-container">
            <input
              type="checkbox"
              id={`checked-${item.listItemID}`}
              onChange={() => checkboxUpdate(item.listItemID)}
...
export default class List extends React.Component<any, ListState> {
    ...
    if (this.state.listInfo === null) {
      ...
      return (
        <div className="List">
          ...
          {/* New list item modal */}
          <div
            className="modal fade ListModal"
            id="new-list-item-modal"
            tabIndex={-1}
            role="dialog"
            aria-labelledby="new-list-item-label"
            aria-hidden="true"
          >
            <div className="modal-dialog" role="document">
              <div className="modal-content">
                <div className="modal-header">
                  <h5 className="modal-title" id="new-list-item-label">
                    New item
                  </h5>
                  <button
                    type="button"
                ...
                <div className="modal-body">
                  <div className="form-group">
                    ...
                    <input
                      ...
                      id="new-item-content"
                      name="new-item-content"
                      maxLength={1023}
                      onChange={() => this.checkNewItemForm()}
                      onKeyDown={(event) =>
                        this.detectSubmit(event, "new-item-button")
                      }
                    />
                  </div>
                </div>
                <div className="modal-footer">
                  ...
                  <button
                    ...
                    data-dismiss="modal"
                    id="new-item-button"
                    onClick={() => this.newListItem()}
                    disabled={
                      !this.state.newItemFormGood ||
          ...
          <div
            className="modal fade ListModal"
            id="edit-list-name-modal"
            tabIndex={-1}
            role="dialog"
            aria-labelledby="edit-list-name-label"
            aria-hidden="true"
          >
            <div className="modal-dialog" role="document">
              <div className="modal-content">
                <div className="modal-header">
                  <h5 className="modal-title" id="edit-list-name-label">
                    Rename list
                  </h5>
                  <button
                    type="button"
                ...
                <div className="modal-body">
                  <div className="form-group">
                    ...
                    <input
                      ...
                      name="list-name"
                      maxLength={255}
                      onChange={() => this.checkEditNameForm()}
                      defaultValue={this.state.listInfo.title}
                      onKeyDown={(event) =>
                        this.detectSubmit(event, "list-rename-button")
                      }
                    />
                  </div>
                </div>
                <div className="modal-footer">
                  ...
                  <button
                    ...
                    className="btn btn-pink"
                    data-dismiss="modal"
                    id="list-rename-button"
                    onClick={() => this.editListName()}
                    disabled={
                      !this.state.editNameFormGood ||
                      this.state.editNameSubmitClicked
                    }
                  >
                    Change name
                  </button>
          ...
          <div
            ...
            tabIndex={-1}
            role="dialog"
            aria-labelledby="delete-list-modal-label"
            aria-hidden="true"
          >
            <div className="modal-dialog" role="document">
              <div className="modal-content">
                <div className="modal-header">
                  <h5 className="modal-title" id="delete-list-modal-label">
                    Delete list
                  </h5>
                  <button
                    type="button"
                ...
                <div className="modal-footer">
                  ...
                  <button
                    ...
                    data-dismiss="modal"
                    disabled={this.state.deleteListClicked}
                  >
                    Delete
                  </button>
                </div>
          ...
          <div
            className="modal fade ListModal"
            id="edit-delete-item-modal"
            tabIndex={-1}
            role="dialog"
            aria-labelledby="edit-delete-item-modal-label"
            aria-hidden="true"
          >
            <div className="modal-dialog" role="document">
              <div className="modal-content">
                <div className="modal-header">
                  <h5 className="modal-title" id="edit-delete-item-modal-label">
                    Edit item
                  </h5>
                  <button
                    type="button"
                ...
                <div className="modal-body">
                  <div className="form-group">
                    ...
                    <input
                      ...
                      name="item-content"
                      maxLength={1023}
                      onChange={() => this.checkEditItemForm()}
                      defaultValue={this.getItemContent(
                        this.state.editingItemID
                      )}
                      onKeyDown={(event) =>
                        this.detectSubmit(event, "edit-item-button")
                      }
                    />
                  </div>
                </div>
                <div className="modal-footer">
                  ...
                  <button
                    ...
                    disabled={
                      !this.state.editItemFormGood ||
                      this.state.editItemSubmitClicked
                    }
                  >
                    Done
                  </button>
  ...
  private async newListItem(): Promise<void> {
    ...
    const newItemContent = (document.getElementById(
      "new-item-content"
  ...
  private async checkNewItemForm(): Promise<void> {
    const itemContent = (document.getElementById(
      "new-item-content"
    ) as HTMLInputElement).value;
