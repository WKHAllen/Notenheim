...
> {
    ...
    if (!this.state.resetRequestSuccess) {
      return (
        <div className="PasswordResetRequest">
          ...
          <p>
            ...
            password. Please use the link quickly, as it will expire after one
            hour. Do not share your link with anyone, or they may be able to
      ...
      return (
        <div className="PasswordResetRequest">
          <h1 className="mb-3">Password Reset</h1>
          <p>
            You will receive an email in the next few minutes containing a link
            that will allow you to reset your password. Please use the link
            quickly, as it will expire after one hour. Do not share your link
            with anyone, or they may be able to gain access to your account!
          </p>
        </div>
      );
    }
  ...
  private async requestPasswordReset(
    ...
    const res = await requestAPIForm("/requestPasswordReset", formData, [
      "email",
    ]);
