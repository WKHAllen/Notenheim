    ...
    if (this.state.validResetID === null) {
      ...
      return (
        <div className="PasswordReset">
          ...
          <p>
            ...
            <code>{this.state.errorMessage}</code>. This may be because the link
            we sent you expired, in which case you should{" "}
      ...
      return (
        <div className="PasswordReset">
          <h1 className="mb-3">Password Reset</h1>
          <p>
            Please enter a new password below. You will only be able to reset
            your password while this link is valid. Do not share this link with
            anyone.
          </p>
          <form
            onSubmit={(event) => {
