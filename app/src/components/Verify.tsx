    ...
    if (this.state.verificationSuccess === null) {
      ...
      return (
        <div className="Verify">
          <h1 className="mb-3">Verify</h1>
          <p>
            Success! Your account has been verified. You may now proceed to{" "}
            <Link to="/login">the login page</Link>. You may also delete the
            email we sent you, as it will serve no further purpose.
          </p>
        </div>
      );
    } else {
      return (
        <div className="Verify">
          ...
          <p>
            ...
            <code>{this.state.errorMessage}</code>. This may be because you have
            already verified your email. It may also be because the link
            expired, in which case you should{" "}
